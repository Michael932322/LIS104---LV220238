...
<?php
 ...
 if($numero1 == -1):
 $backlink = "<a class='d-block text-muted text-small'
href=\"{$_SERVER['PHP_SELF']}\" title=\"Regresar\">";
 $backlink .= "<span class=\"a-btn-text\">Ingresar dato</span>";
 $backlink .= "<span class=\"a-btn-slidetext\">nuevamente</span>";
 $backlink .= "</a>";
 echo $backlink;
 exit(0);
 endif;
 ...
 $tabla .= "<thead>";
 $tabla .= "<tr><th colspan='2' class='mx-auto'>Generando serie de
Fibonacci</th></tr>";
 ...
 $tabla .= "<tbody></table>";
 echo $tabla;
 echo "<br /><a href=\"{$_SERVER['PHP_SELF']}\" title=\"Regresar\"
class=\"a-btn\">";
...
style="visibility:hidden;">
 ...
 <input type="submit" name="enviar" value="Generar" class="btn btnprimary" />&nbsp;
 <input type="reset" name="limpiar" value="Cancelar" class="btn btnprimary" />
</form>
